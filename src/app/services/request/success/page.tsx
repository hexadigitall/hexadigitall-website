    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">Confirming Your Payment</h2>
          <p className="text-gray-600 dark:text-slate-400">Please wait while we process your service request...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">Payment Confirmation Failed</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="px-8 py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Request Information */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Request Details</h3>
                <div className="space-y-3">
                  <div>
                    <span className="text-sm font-medium text-gray-600 dark:text-slate-400">Request ID:</span>
                    <p className="text-gray-900 dark:text-slate-200 font-mono">{serviceRequest?.requestId}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-600 dark:text-slate-400">Service:</span>
                    <p className="text-gray-900 dark:text-slate-200">{serviceRequest?.selectedPackage?.name}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="text-sm font-medium text-gray-600 dark:text-slate-400">Total Paid:</span>
                    <p className="text-gray-900 dark:text-slate-200 font-semibold">${serviceRequest?.totalAmount}</p>
                  </div>
                </div>
              </div>
              ...
              {/* Project Information */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Project Information</h3>
                <div className="space-y-3">
                  <div>
                    <span className="text-sm font-medium text-gray-600 dark:text-slate-400">Project Title:</span>
                    <p className="text-gray-900 dark:text-slate-200">{serviceRequest?.projectDetails?.title}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-600 dark:text-slate-400">Client:</span>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-slate-200">{serviceRequest?.clientInfo?.email}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Next Steps */}
        <div className="mt-8 bg-white dark:bg-slate-900 rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-2">1. Initial Review</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-2">2. Project Kickoff</h3>
              <p className="text-gray-600 dark:text-slate-400">
