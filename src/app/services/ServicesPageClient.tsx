...
export default function ServicesPageClient() {
  // ✅ Added convertPrice to destructuring
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
              {/* 1. Tiered Packages */}
              <div className="group relative p-6 bg-white rounded-xl border-2 border-blue-200 hover:border-blue-500 hover:shadow-lg transition-all flex flex-col">
                <Link href="#packages" className="absolute inset-0 z-0" aria-label="Browse Tiered Packages" />
                <div className="text-4xl mb-2">📦</div>
                <h3 className="text-xl font-bold text-gray-900 mb-1 group-hover:text-blue-600">Tiered Packages</h3>
                <p className="text-sm text-gray-600 mb-4 flex-grow">
                  Complete solutions (Basic/Standard/Premium) for full projects like websites or business plans.
                </p>
                <div className="flex items-center justify-between mt-auto relative z-10">
                  <span className="text-blue-600 font-semibold text-sm group-hover:translate-x-1 transition-transform">Browse Packages →</span>
                  <button 
                    onClick={(e) => handleWhatsAppClick("Hello, I'd like to discuss your service packages.", e)}
              ...
              {/* 2. Custom Build */}
              <div className="group relative p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-indigo-300 hover:border-indigo-500 hover:shadow-lg transition-all flex flex-col">
                <Link href="/services/custom-build" className="absolute inset-0 z-0" aria-label="Start Custom Build" />
                <div className="text-4xl mb-2">🧭</div>
                <h3 className="text-xl font-bold text-gray-900 mb-1 group-hover:text-indigo-600">Custom Build Wizard</h3>
                <p className="text-sm text-gray-600 mb-4 flex-grow">
                  Configure your platform, features, and services with live pricing. Perfect for unique software needs.
                </p>
                <div className="flex items-center justify-between mt-auto relative z-10">
                  <span className="text-indigo-600 font-semibold text-sm group-hover:translate-x-1 transition-transform">Start Building →</span>
                  <button 
                    onClick={(e) => handleWhatsAppClick("Hello, I'm interested in a Custom Software Build.", e)}
                    className="text-gray-400 hover:text-green-600 transition-colors"
                    title="Chat on WhatsApp"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
              ...
              {/* 3. A La Carte */}
              <div className="group relative p-6 bg-white rounded-xl border-2 border-green-200 hover:border-green-500 hover:shadow-lg transition-all flex flex-col">
                <Link href="/services/build-bundle" className="absolute inset-0 z-0" aria-label="Build Bundle" />
                <div className="text-4xl mb-2">🛒</div>
                <h3 className="text-xl font-bold text-gray-900 mb-1 group-hover:text-green-600">À La Carte Builder</h3>
                <p className="text-sm text-gray-600 mb-4 flex-grow">
                  Pick individual services (logo, audit, SEO, support) from any category and bundle them your way.
                </p>
                <div className="flex items-center justify-between mt-auto relative z-10">
                  <span className="text-green-600 font-semibold text-sm group-hover:translate-x-1 transition-transform">Build Your Bundle →</span>
                  <button 
                    onClick={(e) => handleWhatsAppClick("Hello, I want to bundle individual services (A La Carte).", e)}
                    className="text-gray-400 hover:text-green-600 transition-colors"
                    title="Chat on WhatsApp"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
