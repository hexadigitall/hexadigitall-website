...
export default function ProfilePortfolioPage() {
  ...
  const serviceCategory = {
    _id: 'profile-portfolio-building',
    title: 'Profile & Portfolio Building',
    slug: { current: 'profile-and-portfolio-building' },
    description: 'Professional portfolio websites and personal branding services to showcase your work and attract opportunities.',
    icon: 'monitor',
    featured: false,
    packages: portfolioPackages.map(pkg => ({
      _key: pkg.id,
      name: pkg.name,
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="card-enhanced rounded-2xl p-8 text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Get individual profile or portfolio services. Perfect for specific career needs.
                </p>
              </div>
              ...
              {!showIndividualServices ? (
                <button
                  ...
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {INDIVIDUAL_SERVICES.map((service) => (
                      <div key={service.id} className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-400 hover:shadow-lg transition-all duration-300">
                        ...
                        <ul className="space-y-1 mb-6">
                          {service.features.slice(0, 4).map((feature, index) => (
                            <li key={index} className="flex items-center text-xs text-gray-600">
                              <svg className="w-3 h-3 text-purple-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Complete Portfolio Packages</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Comprehensive packages that build your professional brand and showcase your work effectively.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {portfolioPackages.map((pkg, index) => (
                ...
                >
                  {pkg.popular && (
                    <div className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-4 py-2 rounded-full text-sm font-bold text-center mb-6">
                      Most Popular
                    </div>
                  )}
                  ...
                  <button className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-3 px-6 rounded-xl font-semibold hover:from-purple-600 hover:to-blue-600 transition-colors">
                    {pkg.cta}
                  </button>
                </div>
              ))}
