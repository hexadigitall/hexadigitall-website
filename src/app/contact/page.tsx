        ...
        <div className="container mx-auto px-6">
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-gray-600 dark:text-slate-400">
              ...
              <li className="text-primary dark:text-cyan-300 font-medium" aria-current="page">Contact Us</li>
            </ol>
          </nav>
          
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-primary dark:text-cyan-300 mb-4">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-lightGray dark:bg-slate-800 p-8 rounded-lg">
              <h2 className="text-2xl font-bold font-heading text-primary dark:text-cyan-300 mb-4">
                Contact Information
              </h2>
              <div className="space-y-6 text-darkText dark:text-slate-300">
                <div>
                  <h3 className="font-semibold text-primary dark:text-cyan-300 mb-2">Email Us</h3>
                  <a href="mailto:hexadigitztech@gmail.com" className="flex items-center hover:text-secondary transition-colors">
                    <svg className="w-5 h-5 mr-2 text-primary dark:text-cyan-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                  <h3 className="font-semibold text-primary dark:text-cyan-300 mb-2">Call Us</h3>
                ...
                <div>
                  <h3 className="font-semibold text-primary dark:text-cyan-300 mb-2">Visit Us</h3>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 mr-2 text-primary dark:text-cyan-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                  <h3 className="font-semibold text-primary dark:text-cyan-300 mb-2">Business Hours</h3>
                  <div className="flex items-start">
                    <svg className="w-5 h-5 mr-2 text-primary dark:text-cyan-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
