    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-800/50 dark:bg-slate-800/50">
            ...
            <div className="flex items-center justify-between gap-2 py-3 min-h-16">
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                ...
                <div className="hidden sm:flex items-center gap-2 border-l pl-2 sm:pl-3">
                  <UserCircleIcon className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400 dark:text-slate-400 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
          {dashboardError && (
            <div className="mb-4 rounded-lg border border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-950/20 px-4 py-3 text-sm text-red-700 dark:text-red-400">
              {dashboardError}
            </div>
          )}
          {/* Quick Stats */}
    ...
    <Link href={href}>
      <div className="bg-white dark:bg-slate-900 rounded-lg sm:rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-4 sm:p-6 hover:shadow-md transition-shadow cursor-pointer group h-full">
        <div className="flex items-start justify-between mb-3 sm:mb-4 gap-2">
          ...
          {count !== undefined && (
            <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-red-100 text-red-600 dark:text-red-400 text-xs sm:text-sm font-medium rounded-full flex-shrink-0">
              {count} new
            </span>
          )}
        </div>
