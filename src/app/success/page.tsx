...
export default function SuccessPage() {
  return (
    <div className="min-h-screen bg-lightGray dark:bg-slate-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div className="mt-8 space-y-4">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold font-heading mb-2 text-gray-900 dark:text-slate-100">What&apos;s Next?</h3>
            <ul className="text-sm text-gray-600 dark:text-slate-400 text-left space-y-2">
