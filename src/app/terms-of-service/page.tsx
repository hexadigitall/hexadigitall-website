      ...
      />
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-4 text-sm text-gray-500 dark:text-slate-500 dark:text-slate-400">
...
<div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-400 dark:border-blue-600 p-4 mb-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 dark:text-slate-300 dark:text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">3.1 Age Requirements</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">3.2 Account Registration</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">4.1 Permitted Uses</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
                You may use our services for lawful business and personal purposes in accordance with these Terms.
              </p>

              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">4.2 Prohibited Activities</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
                You agree not to:
              </p>
              <ul className="list-disc list-inside text-gray-700 dark:text-slate-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">5.1 Pricing and Fees</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">5.2 Payment Methods</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">5.3 Payment Terms</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-slate-300 mb-4 space-y-2">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">5.4 Refund Policy</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">6.1 Our Intellectual Property</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">6.2 Client Work Product</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">6.3 User Content</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">8.1 Project Timelines</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">8.2 Client Responsibilities</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">8.3 Revisions and Changes</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">9.1 Service Disclaimer</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">9.2 Third-Party Services</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">10.1 Termination by You</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">10.2 Termination by Us</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">10.3 Effect of Termination</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">11.1 Governing Law</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">11.2 Dispute Resolution</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">12.1 Entire Agreement</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">12.2 Changes to Terms</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">12.3 Severability</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
                If any provision of these Terms is found to be unenforceable, the remaining provisions will continue in full force and effect.
              </p>

              <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-200 mb-3">12.4 Assignment</h3>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed mb-4">
