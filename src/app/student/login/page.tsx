...
export default function StudentLoginPage() {
  ...
  const handleOAuth = async (provider: 'google' | 'github') => {
    setError('')
    localStorage.setItem('student_oauth_intent', 'signin')
    document.cookie = 'student_oauth_intent=signin; Path=/; Max-Age=600; SameSite=Lax'
    await signIn(provider, { callbackUrl: '/student/oauth-success?intent=signin' })
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-blue-50 to-white dark:from-slate-950 dark:via-indigo-950/40 dark:to-slate-900 px-4">
