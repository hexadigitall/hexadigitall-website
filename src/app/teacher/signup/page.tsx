...
export default function TeacherSignupPage() {
  ...
  const handleOAuth = async (provider: 'google' | 'github') => {
    ...
    localStorage.setItem('teacher_oauth_intent', 'signup')
              ...
              <div className="space-y-3 mb-6">
                {oauthProviders.google && (
                  <button
                    ...
                    className="w-full py-3 border border-gray-300 bg-white text-gray-800 font-medium rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                  >
                    {oauthLoading === 'google'
