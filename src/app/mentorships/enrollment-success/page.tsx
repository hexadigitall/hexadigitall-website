  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-teal-50">
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className="rounded-3xl border border-amber-200 bg-white/90 p-8 shadow-xl">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Mentorship Enrollment Confirmed</h1>
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_1fr]">
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-teal-200 bg-teal-50 p-6">
                <h3 className="text-lg font-semibold text-slate-900">WhatsApp handoff</h3>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-slate-900">Mentorship summary</h3>
              <div className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-slate-900">{courseTitle}</p>
                </div>
                {course?.instructor ? (
                  <div>
                    <p className="text-sm text-slate-500">Lead mentor</p>
                ...
                {course?.level ? (
                  <div>
                    ...
                    <p className="text-sm font-medium text-slate-700">{course.level}</p>
                  </div>
                ) : null}
              </div>
              ...
              <div className="mt-6 space-y-3">
                <Link
                  ...
                  className="inline-flex w-full items-center justify-center rounded-lg border border-slate-300 px-4 py-3 text-sm font-semibold text-slate-700 transition-colors hover:border-slate-400"
                >
          ...
          <div className="mt-10 rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-4 text-sm text-slate-600">
