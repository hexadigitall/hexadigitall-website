...
import { devopsEngineeringAssessments } from '@/lib/course-assessments/devops-engineering-cloud-infrastructure-core'

const registry: Record<string, CourseAssessmentDefinition[]> = {
  'architecting-landing-zones': architectingLandingZonesAssessments,
  'devops-engineering-cloud-infrastructure-core': devopsEngineeringAssessments,
}
