      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="mb-6">
                    <StartingAtPriceDisplay 
                      ...
                      className=""
                    />
                    <p className="text-sm text-gray-600 dark:text-slate-400 mt-2">{tier.billing || 'One-time payment'}</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center group ${
                    tier.popular
                      ...
                      : 'bg-gray-100 dark:bg-slate-700 text-gray-900 dark:text-slate-100 hover:bg-blue-50 hover:text-blue-600 border-2 border-transparent hover:border-blue-200'
                  }`}
                >
                  {tier.cta}
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 max-w-4xl mx-auto border border-blue-200">
            ...
            <h4 className="font-semibold text-gray-900 dark:text-slate-100 mb-3 text-lg">
