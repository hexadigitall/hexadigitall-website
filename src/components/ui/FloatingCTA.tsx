          ...
          <AnimatePresence>
            {isExpanded && (
              <motion.div
                ...
                exit={{ opacity: 0, y: 20 }}
                className="absolute bottom-16 right-0 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/50 dark:border-slate-700/50 p-4 min-w-[220px]"
              >
                <div className="space-y-3">
                  {/* 1. WhatsApp Option (Primary) */}
                  <button
                    onClick={handleWhatsAppClick}
                    className="w-full flex items-center space-x-3 p-3 rounded-xl hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 group text-left"
                  >
                    ...
                    <span className="text-gray-800 dark:text-slate-200 font-medium">Chat on WhatsApp</span>
                  </button>

                  <Link
                    href="/contact"
                    className="flex items-center space-x-3 p-3 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 group"
                  >
                    <div className="p-2 bg-blue-500 rounded-lg text-white group-hover:shadow-lg transition-shadow">
                      <ChatBubbleLeftEllipsisIcon className="w-5 h-5" />
                    </div>
                    <span className="text-gray-800 dark:text-slate-200 font-medium">Get Free Quote</span>
                  </Link>
                  
                  <Link
                    href="tel:+2348125802140"
                    className="flex items-center space-x-3 p-3 rounded-xl hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-all duration-300 group"
                  >
                    <div className="p-2 bg-teal-500 rounded-lg text-white group-hover:shadow-lg transition-shadow">
                      <PhoneIcon className="w-5 h-5" />
                    </div>
                    <span className="text-gray-800 dark:text-slate-200 font-medium">Call Now</span>
                  </Link>
                  
                  <Link
                    href="mailto:info@hexadigitall.com"
                    className="flex items-center space-x-3 p-3 rounded-xl hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all duration-300 group"
                  >
                    <div className="p-2 bg-orange-500 rounded-lg text-white group-hover:shadow-lg transition-shadow">
                      <EnvelopeIcon className="w-5 h-5" />
                    </div>
                    <span className="text-gray-800 dark:text-slate-200 font-medium">Send Email</span>
                  </Link>
                </div>
              </motion.div>
            )}
