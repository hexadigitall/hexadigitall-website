  ...
  return (
    <div className="mb-4 p-4 rounded-lg bg-gradient-to-r from-green-50 to-blue-50 border border-green-100">
      <div className="flex items-start justify-between">
        <div className="mr-4">
          <h4 className="text-sm font-semibold text-gray-900 dark:text-slate-100">Welcome — let’s make this simple</h4>
          <p className="text-xs text-gray-600 dark:text-slate-400 mt-1">We’ll guide you through 3 quick steps to get a tailored quote. You can skip anytime.</p>

          <ol className="mt-3 text-xs text-gray-700 dark:text-slate-300 space-y-1 list-decimal list-inside">
