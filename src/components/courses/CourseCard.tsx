      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="space-y-3 mt-auto">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:border-slate-300 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-100 dark:hover:bg-slate-700 transition-colors text-sm font-semibold"
          >
            Mentorship Only (Textbook Learners)
          </Link>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center w-full px-3 py-2 text-primary dark:text-cyan-300 border border-primary dark:border-cyan-700 rounded-lg hover:bg-primary/5 dark:hover:bg-slate-700 transition-colors text-sm font-medium"
            >
              Learn More
            </Link>

            <Link
              href={`/courses/${safeSlug}/curriculum`}
              className="inline-flex items-center justify-center w-full px-3 py-2 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors text-sm font-medium"
            >
              Curriculum
            </Link>
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-full px-3 py-2 text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors text-sm font-medium col-span-2"
            >
