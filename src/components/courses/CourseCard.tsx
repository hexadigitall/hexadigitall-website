      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="space-y-3 mt-auto">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center w-full px-4 py-2 rounded-lg border border-slate-200 text-slate-700 hover:border-slate-300 hover:text-slate-900 transition-colors text-sm font-semibold"
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center w-full px-3 py-2 text-blue-700 border border-blue-200 rounded-lg hover:bg-blue-50 transition-colors text-sm font-medium"
            >
              Curriculum
            </Link>
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-full px-3 py-2 text-green-700 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition-colors text-sm font-medium col-span-2"
            >
