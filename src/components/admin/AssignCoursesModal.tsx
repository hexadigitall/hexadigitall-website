      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-slate-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Assign Courses</h2>
              <p className="text-sm text-gray-600 dark:text-slate-400">{teacherName}</p>
            </div>
          </div>
          <button
            onClick={onClose}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {course.description && (
                        <div className="text-sm text-gray-600 dark:text-slate-400 mt-1 line-clamp-2">
                          {course.description}
                        </div>
                      )}
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-slate-700">
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={onClose}
              className="px-4 py-2 text-gray-700 dark:text-slate-300 hover:text-gray-900 dark:text-slate-100 rounded-lg hover:bg-gray-100"
            >
              Cancel
            </button>
            <button
