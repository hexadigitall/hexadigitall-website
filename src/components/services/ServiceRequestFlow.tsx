        ...
        >
          ...
          <div className="flex-shrink-0 flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-slate-700">
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100">{serviceCategory.title}</h2>
              <p className="text-sm text-gray-600 dark:text-slate-400 mt-1 hidden sm:block truncate">{serviceCategory.description}</p>
            </div>
            {onClose && (
              <button
                onClick={onClose}
                className="ml-4 p-2 text-gray-400 dark:text-slate-500 dark:text-slate-400 hover:text-gray-600 dark:text-slate-400 transition-colors flex-shrink-0"
                aria-label="Close"
              >
                ...
                <React.Fragment key={step.number}>
                  <div className="flex items-center">
                    ...
                    <div className="ml-2 hidden sm:block">
                      ...
                      <div className="text-xs text-gray-400 dark:text-slate-500 dark:text-slate-400 truncate">{step.description}</div>
                    </div>
                  </div>
              ...
              <>
                ...
                <div className="flex justify-end px-2 mb-4">
                  <button 
                    ...
                    className="flex items-center space-x-2 text-green-600 dark:text-green-400 hover:text-green-700 bg-green-50 dark:bg-green-950/20 px-3 py-2 rounded-lg transition-colors text-sm font-medium"
                  >
