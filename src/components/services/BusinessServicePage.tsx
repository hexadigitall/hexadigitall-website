        ...
        <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {individualServices.map((service) => (
                      <div key={service.id} className="bg-white dark:bg-slate-900 border-2 border-gray-200 dark:border-slate-700 rounded-xl p-6 hover:border-blue-400 hover:shadow-lg transition-all duration-300">
                        ...
                        <div className="mb-4">
                          <StartingAtPriceDisplay 
                            ...
                            showDiscount={true}
                          />
                          <p className="text-sm text-gray-500 dark:text-slate-500 dark:text-slate-400 mt-1">Delivery: {service.deliveryTime}</p>
                        </div>
                        ...
                        <button 
                          ...
                          className="w-full bg-blue-50 dark:bg-blue-950/200 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors font-medium"
                        >
                          Select This Service
                        </button>
                      </div>
                  ...
                  <button
                    ...
                    className="text-gray-500 dark:text-slate-500 dark:text-slate-400 hover:text-gray-700 dark:text-gray-300 dark:text-slate-300 text-sm"
                  >
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-4">Complete Business Packages</h2>
                    ...
                    {pkg.features.slice(0, 8).map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start">
                        <svg className="w-5 h-5 text-blue-500 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                          ...
                          <span className="text-gray-700 dark:text-gray-300 dark:text-slate-300 text-sm">
                            {typeof feature === 'string' ? feature : (feature.title || feature.description || JSON.stringify(feature))}
                          </span>
                      </li>
                    ))}
                    {pkg.features.length > 8 && (
                      <li className="text-sm text-gray-500 dark:text-slate-500 dark:text-slate-400 italic pl-8">
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-8">Why Choose Our Business Services?</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">{serviceStats.fundingSuccessRate}% Funding Success</h4>
                <p className="text-gray-600 dark:text-slate-400 text-sm">Our business plans help secure funding 3x more than industry average</p>
              </div>
              ...
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">{serviceStats.totalFundingRaised} Raised</h4>
                <p className="text-gray-600 dark:text-slate-400 text-sm">Total funding raised by our clients across 150+ startups</p>
              </div>
              ...
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">{serviceStats.averageRevenueGrowth}% Revenue Growth</h4>
                <p className="text-gray-600 dark:text-slate-400 text-sm">Average revenue increase within 12 months of plan implementation</p>
              </div>
              ...
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">{serviceStats.averageDeliveryTime} Delivery</h4>
                <p className="text-gray-600 dark:text-slate-400 text-sm">Comprehensive business plans delivered faster than traditional consultants</p>
              </div>
            </div>
          </div>
        </div>
