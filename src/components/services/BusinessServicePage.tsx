        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-4">Complete Business Packages</h2>
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-8">Why Choose Our Business Services?</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-slate-100 mb-2">{serviceStats.fundingSuccessRate}% Funding Success</h4>
              ...
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-slate-100 mb-2">{serviceStats.totalFundingRaised} Raised</h4>
              ...
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-slate-100 mb-2">{serviceStats.averageRevenueGrowth}% Revenue Growth</h4>
              ...
              <div className="card-enhanced rounded-xl p-6 text-center">
                ...
                <h4 className="font-bold text-gray-900 dark:text-slate-100 mb-2">{serviceStats.averageDeliveryTime} Delivery</h4>
