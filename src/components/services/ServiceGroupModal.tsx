            ...
            {group.packages.map((pkg) => (
              ...
              >
                ...
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">{pkg.name}</h3>
                  <div className="mb-4">
                  ...
                  <ul className="space-y-2">
                    {pkg.features.slice(0, 5).map((feature, index) => (
                      <li key={index} className="flex items-start text-sm">
                        ...
                        <span className="text-gray-700 dark:text-gray-300 dark:text-slate-300">{featureToText(feature)}</span>
                      </li>
                    ))}
    ...
    >
      ...
      <div className="relative z-10 p-8">
        <div className="flex items-center mb-4">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 group-hover:text-primary transition-colors">
              {group.name}
            </h3>
        ...
        <p className="text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-6 leading-relaxed">
          {group.description}
        </p>
