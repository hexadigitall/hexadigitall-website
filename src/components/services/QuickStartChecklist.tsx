    ...
    <div className={`bg-white dark:bg-slate-900 rounded-xl shadow-md p-6 ${className}`}>
          ...
          <div key={item.id} className="flex items-start space-x-4">
            <div className="flex-shrink-0">
              <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                <span className="text-primary dark:text-cyan-300 font-semibold text-sm">{index + 1}</span>
              </div>
            </div>
      ...
      <div className="mt-6 pt-6 border-t">
        <p className="text-sm text-gray-600 dark:text-slate-400 text-center">
          Need help getting started? <a href="/contact" className="text-primary dark:text-cyan-400 hover:underline font-medium">Contact our team</a>
        </p>
      </div>
    </div>
  )
