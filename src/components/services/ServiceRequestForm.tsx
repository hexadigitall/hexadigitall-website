...
export const ServiceRequestForm: React.FC<ServiceRequestFormProps> = ({
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="p-6">
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">Contact Information</h3>
        ...
        <div className="bg-gray-50 dark:bg-slate-800/50 rounded-lg p-4 mb-8">
          <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">Selected Package</h4>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          {/* Contact Information */}
          <div>
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-4">Contact Information</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-4">Additional Information</h4>
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-2">
              ...
              />
              <p className="text-sm text-gray-500 dark:text-slate-500 dark:text-slate-400 mt-1">
          ...
          {serviceCategory.requirements && serviceCategory.requirements.length > 0 && (
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-6">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-4">
              ...
              <ul className="space-y-2">
                {serviceCategory.requirements.map((requirement, index) => (
                  <li key={index} className="flex items-start">
                    ...
                    <span className="text-gray-700 dark:text-gray-300 dark:text-slate-300">{requirement}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t">
            <button
              type="button"
              onClick={onBack}
              className="sm:w-auto px-6 py-3 border border-gray-300 text-gray-700 dark:text-gray-300 dark:text-slate-300 rounded-lg hover:bg-gray-50 dark:bg-slate-800/50 transition-colors"
            >
              Back to Packages
            </button>
            <button
