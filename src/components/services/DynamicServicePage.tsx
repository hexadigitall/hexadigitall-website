        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          {individualServices.length > 0 && (
            <div className="mb-16">
              <div className="card-enhanced rounded-2xl p-8 text-center">
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-3">{config.individualTitle}</h2>
                        ...
                        <div key={service.id} className={`bg-white dark:bg-slate-900 border-2 border-gray-200 dark:border-slate-700 rounded-xl p-6 hover:border-${config.accentColor}-400 hover:shadow-lg transition-all duration-300 flex flex-col h-full`}>
                          ...
                          <div className="grid grid-cols-2 gap-2 mt-auto">
                            <button
                              ...
                              className="flex items-center justify-center px-2 py-2 border border-green-500 text-green-600 dark:text-green-400 rounded-lg hover:bg-green-50 dark:bg-green-950/20 transition-colors font-medium text-xs"
                            >
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-4">{config.packageTitle}</h2>
                ...
                >
                  ...
                  <ul className="space-y-3 mb-8 flex-grow">
                    {(pkg.features || []).slice(0, 8).map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start">
                        ...
                        <span className="text-gray-700 dark:text-gray-300 dark:text-slate-300 text-sm">{typeof feature === 'string' ? feature : (feature.title ?? feature.description ?? JSON.stringify(feature))}</span>
                      </li>
                    ))}
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-auto">
                    <button
                      ...
                      className="flex items-center justify-center px-3 py-3 border-2 border-green-500 text-green-600 dark:text-green-400 rounded-xl hover:bg-green-50 dark:bg-green-950/20 transition-colors font-bold text-sm"
                    >
          ...
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-8">{config.statsTitle}</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {getStatsData().map((stat) => (
                <div key={stat.title} className="card-enhanced rounded-xl p-6 text-center">
                  ...
                  <h4 className="font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">{stat.title}</h4>
