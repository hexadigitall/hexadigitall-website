      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-slate-700">
        ...
        <div className="p-6">
                ...
                if (course.sessionOptions.fixedPrice) {
                  ...
                  return (
                    <div className="space-y-2">
                      <div className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100">Flexible Pricing</div>
          ...
          {(course.sessionOptions.perSession || course.sessionOptions.hourly) && (
            <div className="mb-6">
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-3">Learning Options:</h4>
              <div className="space-y-2">
          ...
          {/* What's Included */}
          <div className="mb-6">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-3">What&apos;s Included:</h4>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-slate-700">
        <div className="mb-6">
          <button 
            ...
            className="flex items-center text-gray-600 dark:text-gray-400 dark:text-slate-400 hover:text-gray-800 dark:text-gray-200 dark:hover:text-slate-300 mb-4"
          >
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100">Customize Your Learning Experience</h3>
          <p className="text-gray-600 dark:text-gray-400">Choose how you&apos;d like to learn this course</p>
        </div>

        <div className="space-y-6">
          {/* Session Type Selection */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-3">Learning Format</label>
          ...
          {sessionCustomization.sessionType === 'per_session' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-1">Number of Sessions</label>
              <input
                type="number"
                min="1"
                max="20"
          ...
          {sessionCustomization.sessionType === 'hourly' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-1">Total Hours</label>
              <input
                type="number"
          ...
          {/* Schedule Preference */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-3">Schedule Preference</label>
          ...
          {/* Learning Intensity */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-3">Learning Intensity</label>
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={intensity.value}>
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">{intensity.desc}</div>
                  </label>
                </div>
              ))}
            </div>
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="button"
              onClick={() => setState({ ...state, step: 'preview' })}
              className="flex-1 py-3 px-6 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 dark:text-slate-300 rounded-lg font-semibold hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
            >
              Back
            </button>
            <button
    ...
    return (
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-slate-700">
        <div className="mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100">Student Information</h3>
          <p className="text-gray-600 dark:text-gray-400">Help us personalize your learning experience</p>
        </div>

        <form onSubmit={handleDetailsSubmit} className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-slate-300 mb-1">
                Full Name *
              </label>
              <input
                type="text"
    ...
    return (
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-slate-700">
        <div className="mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-slate-100">Enrollment Summary</h3>
        </div>
        ...
        {(course.sessionOptions.perSession || course.sessionOptions.hourly) && (
          <div className="border-t pt-4 mb-6">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-3">Learning Configuration</h4>
            <div className="space-y-2 text-sm">
              <p><span className="text-gray-600 dark:text-gray-400">Format:</span> {
              ...
              <p><span className="text-gray-600 dark:text-gray-400">Schedule:</span> {sessionCustomization.schedule}</p>
              <p><span className="text-gray-600 dark:text-gray-400">Intensity:</span> {sessionCustomization.intensity.replace('_', ' ')}</p>
            </div>
          </div>
        )}
        ...
        <div className="border-t pt-4 mb-6">
          <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-3">Student Information</h4>
          <div className="space-y-2 text-sm">
            <p><span className="text-gray-600 dark:text-gray-400">Name:</span> {studentDetails.fullName}</p>
            <p><span className="text-gray-600 dark:text-gray-400">Email:</span> {studentDetails.email}</p>
            <p><span className="text-gray-600 dark:text-gray-400">Phone:</span> {studentDetails.phone}</p>
            {studentDetails.experience && (
              <p><span className="text-gray-600 dark:text-gray-400">Experience:</span> {studentDetails.experience}</p>
            )}
            {studentDetails.preferredTime && (
              <p><span className="text-gray-600 dark:text-gray-400">Preferred Time:</span> {studentDetails.preferredTime}</p>
            )}
          </div>
        </div>
        ...
        {qualifiesForInstallments && (
          <div className="mb-6">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-3">Choose Payment Plan</h4>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h5 className="font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100">{plan.name}</h5>
                      {plan.id === 'split_2' && (
        ...
        <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 mb-6">
          <h4 className="font-semibold text-blue-900 dark:text-blue-300 mb-2">Payment Summary</h4>
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg p-6 border border-red-200">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 dark:text-slate-100 mb-2">Enrollment Failed</h3>
          ...
          <div className="flex gap-3">
            ...
            <Link 
              href="/contact"
              className="flex-1 py-2 px-4 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 dark:text-slate-300 rounded-lg font-medium hover:bg-gray-50 dark:hover:bg-slate-700 text-center"
            >
              Contact Support
            </Link>
          </div>
