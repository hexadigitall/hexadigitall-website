...
import CoursePricingCalculator, { PricingConfiguration } from '@/components/courses/CoursePricingCalculator'
...
export function MentorshipEnrollmentModal({
  isOpen,
  onClose,
  course,
  successPath = '/mentorships/enrollment-success'
}: MentorshipEnrollmentModalProps) {
          ...
          <div className="relative w-24 h-24 rounded-xl overflow-hidden flex-shrink-0">
            {course.mainImage ? (
              ...
              <div className="w-full h-full bg-gradient-to-br from-primary/20 to-primary/40 flex items-center justify-center">
                <svg className="w-8 h-8 text-primary dark:text-cyan-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <ul className="space-y-1 text-blue-700 dark:text-blue-300">
                {isLiveCourse ? (
                  <>
                    ...
                    <li>• You&apos;ll receive your Google Classroom invite and assessment workflow</li>
                    <li>• Sessions are scheduled based on your selected preferences</li>
                    <li>• Monthly billing continues while your subscription is active</li>
                    <li>• You can pause or cancel anytime with one week notice</li>
                  </>
                ) : (
                  <>
                    <li>• You&apos;ll receive mentorship onboarding instructions by email</li>
                    <li>• Mentor assignment and classroom setup begins immediately</li>
                    <li>• Access to the mentorship support channel and grading workflow</li>
                    <li>• Billing and support details are shared in your confirmation email</li>
                  </>
                )}
              </ul>
            </div>
