            ...
            {(() => {
              if (isLiveCourse) {
                ...
                return (
                  <div className="space-y-1">
                    <div className="text-sm text-gray-600 dark:text-slate-400">Starting from</div>
              ...
              if (course.dollarPrice && course.dollarPrice > 0) {
                ...
                if (priceInfo.hasDiscount) {
                  return (
                    <div className="space-y-1">
                      <span className="text-lg text-gray-500 dark:text-slate-400 line-through block">{priceInfo.originalPrice}</span>
