    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-slate-700">
      ...
      <div className="p-6">
            ...
            {(() => {
              if (isLiveCourse) {
                ...
                return (
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-slate-400">/month</div>
                    <div className="text-xs text-blue-600 dark:text-blue-400 mt-1">💡 Monthly Subscription • Flexible Scheduling</div>
                  </div>
                );
              }
              ...
              if (course.dollarPrice && course.dollarPrice > 0) {
                ...
                if (priceInfo.hasDiscount) {
                  return (
                    <div className="space-y-1">
                      <span className="text-lg text-gray-500 dark:text-gray-400 dark:text-slate-400 line-through block">{priceInfo.originalPrice}</span>
                      <span className="text-3xl font-bold text-green-600 dark:text-green-400">{priceInfo.discountedPrice}</span>
                    </div>
                  )
                } else {
        ...
        <div className="space-y-3 mb-6">
          <div className="flex items-center text-sm text-gray-600 dark:text-gray-400 dark:text-slate-400">
        ...
        <div className="mb-6">
          ...
          <ul className="space-y-2">
            {(course.includes || []).map((item, index) => (
              <li key={index} className="flex items-start text-sm text-gray-600 dark:text-gray-400 dark:text-slate-400">
        ...
        <div className="space-y-3">
          <button
            ...
            className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-200 ${
              isAvailable
                ...
                : 'bg-gray-300 dark:bg-slate-600 text-gray-500 dark:text-gray-400 dark:text-slate-400 cursor-not-allowed'
            }`}
          >
          ...
          <button
            ...
            className="w-full py-3 px-6 rounded-lg font-semibold border-2 border-green-500 text-green-600 dark:text-green-400 hover:bg-green-50 dark:bg-green-950/20 transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-4 text-center">
          <div className="flex items-center justify-center text-sm text-gray-600 dark:text-gray-400 dark:text-slate-400">
