            ...
            <ul className="space-y-3">
              <li>
                <Link href="/services" className="text-accent hover:text-white font-medium transition-colors duration-300 flex items-center group">
                  <span className="w-1 h-1 bg-accent rounded-full mr-3 group-hover:bg-white dark:bg-slate-900 transition-colors duration-300" />
                  All Services
                </Link>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <a 
                ...
                className="w-10 h-10 bg-white dark:bg-slate-900/10 hover:bg-green-500 rounded-full flex items-center justify-center transition-colors duration-300 group" 
              ...
              {/* Twitter */}
              <a href="#" className="w-10 h-10 bg-white dark:bg-slate-900/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors duration-300 group" title="Follow us on Twitter">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a href="#" className="w-10 h-10 bg-white dark:bg-slate-900/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors duration-300 group" title="Follow us on Instagram">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="#" className="w-10 h-10 bg-white dark:bg-slate-900/10 hover:bg-accent rounded-full flex items-center justify-center transition-colors duration-300 group" title="Connect on LinkedIn">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <span className="text-gray-400 dark:text-slate-500">Made with ❤️ in Nigeria</span>
            </div>
          </div>
        </div>
      </div>
