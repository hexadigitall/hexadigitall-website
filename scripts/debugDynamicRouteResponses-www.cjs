#!/usr/bin/env node
// scripts/debugDynamicRouteResponses-www.cjs
// Uses https module to fetch and log HTTP status and response body for sample dynamic URLs (www-prefixed)
...
const urls = [
  ...
  'https://www.hexadigitall.com/courses/category/web-mobile-development',
